...
define( 'KB_FIELD_PATH', plugin_dir_path( __FILE__ ) . 'fields/' );
define( 'KB_FIELD_CSS', plugin_dir_url( __FILE__ ) . 'fields/css/' );
define( 'KB_FIELD_JS', plugin_dir_url( __FILE__ ) . 'fields/js/' );
...
add_action( 'init', 'init_Kontentfields', 15 );
