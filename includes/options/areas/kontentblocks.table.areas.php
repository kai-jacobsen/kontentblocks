...
Class Kontentblocks_Areas_Table extends \WP_List_Table
{
	/**
	...
	function __construct()
	{
        ...
        parent::__construct( array(
            'singular'  => 'dynamic area',     //singular name of the listed records
            'plural'    => 'dynamic areas',    //plural name of the listed records
	...
	private function get_data()
	{
		...
		$this->areas = $Kontentblocks->get_dynamic_areas(false, 'side');
	}
	...
	function column_name($item)
	{
		...
		else
		{
			$actions = array(
				...
				'settings'	=> sprintf('<a href="?page=%s&action=%s&area=%s">Einstellungen</a>',$_REQUEST['page'],'edit-settings',$item['id'])
			);
		}
