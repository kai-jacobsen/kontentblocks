/*! Kontentblocks DevVersion 2014-10-26 */
!function(a, b) {
    "use strict";
    var c, d = a.document;
    c = function() {
...
(function(factory) {
    ...
    function filterOverlaps(collection1, collection2) {
        var dims1 = getDims(collection1), dims2 = !collection2 ? dims1 : getDims(collection2), stack = [], index1 = 0, index2 = 0, length1 = dims1.length, length2 = !collection2 ? dims1.length : dims2.length;
        if (!collection2) {
