...
class PageSettings
{
	...
	public static function page_template_content()
	{
		...
		$l18n_parent	= __('Elternseite', 'reframe');
		$l18n_template	= __('Seitenvorlage', 'reframe');
		
		echo "<div class='page-template-wrapper context-area'>";
		
		echo "<div class='context-header'><h2>Page Settings</h2></div>";
...
//add_action( 'save_post', array( 'ReFrame_Template_Meta_Box', 'save_page_template' ), 9999, 1 );
